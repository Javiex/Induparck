...
app.config(function($stateProvider, $urlRouterProvider) {
   ...
   .state('movementdocument', {
      url: "/movementdocument/:idmovement",
      views: {
         'main': {
            templateUrl: 'templates/movementDocument.html',
            controller: 'MovementDocumentController'
         }
      }
   })
   ...
   .state('requerimentedit',{
      url: "/requerimentedit/:idrequeriment",
      views:{
         'main': {
            templateUrl: 'templates/requerimentEdit.html',
            controller: 'RequerimentDetailController'
         }
      }
   })
