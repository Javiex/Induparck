...
app.factory("Movement", function($http) {
   ...
   movement.getMovement = function(idMovement) {
      var url = baseUrl + "movement_data/" + idMovement;
      return $http.get(url).then(function(response){
         return response.data;
      });
   };

   movement.codeMovement = function(movementType) {
      var url = baseUrl + "code_movement/" + movementType;
      return $http.get(url).then(function(response) {
         return response.data;
      });
   };
   movement.createMovement = function(params) {
      var url = baseUrl + "create_movement";
      return $http.post(url, params).then(function(response) {
         return response.data;
      });
   };
...
app.factory('PaymentDocument', function($http) {
   var baseUrl = 'http://localhost/api/';

   function paymentdocument() {}

   paymentdocument.loadDocument = function() {
      var url = baseUrl + 'paymentDocument';
      return $http.get(url).then(function(response) {
         return response.data;
      });
   };
...
app.factory("Requeriment", function($http) {
   ...
   requeriment.getOneRequeriment = function(idRequeriment) {
      var url = baseUrl + '/requeriment_one/' + idRequeriment;
      return $http.get(url).then(function(response) {
         return response.data;
      });
   };

   requeriment.getOneRequerimentDetail = function(idRequeriment) {
      var url = baseUrl + '/requeriment_detail_one/' + idRequeriment;
      return $http.get(url).then(function(response) {
         return response.data;
      });
   };

   requeriment.createRequerimentxWarehouse = function(params) {
      var url = baseUrl + "create_requeriment";
      return $http.post(url, params).then(function(response) {
         return response.data;
      });
   };
